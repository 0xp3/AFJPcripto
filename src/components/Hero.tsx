      ...
      <div className="container relative z-10">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <span className="uppercase tracking-wider text-sm font-medium">El Futuro de las Jubilaciones</span>
            <div className="h-3 w-3 rounded-full bg-polkadot-purple animate-pulse"></div>
          </div>
          
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            <span className="text-gradient">Polkadot:</span> El Ecosistema Ideal para Nuestra AFJP Cripto
          </h1>
          
          <p className="text-lg md:text-xl text-foreground/80 mb-8 max-w-2xl">
            Incorporar Polkadot no es solo una elección tecnológica; es una declaración de solidez, 
            escalabilidad y visión de futuro para un sistema de jubilación del siglo XXI.
          </p>
